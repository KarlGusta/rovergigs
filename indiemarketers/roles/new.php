    ...
    <header class="navbar navbar-expand-md navbar-light d-print-none">
            <div class="container-xl">
                <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                    <a href="/indiemarketers" style="text-decoration: none;">
                        <p>IndieMarketers</p>
                    </a>
                </h1>
                        ...
                        <div class="row row-cards row-deck">
                            ...
                            <div class="col" style='cursor: pointer;'
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="text-secondary">You're a Copywriter/Marketer looking for your next
                                            gig.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col" style='cursor: pointer;'
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h2>I'm hiring marketers</h2>
                                        <p class="text-secondary">You're a business looking to hire a freelance,
                                            part-time, or full-time Copywriter/Marketer.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
