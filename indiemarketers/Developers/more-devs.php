                        ...
                        <div class="card card-md">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h2 class="page-title">Hire Copywriters and Marketers</h2>
                                        <p class="m-0 text-secondary">1300+ copywriters and marketers looking for their
                                            next gig. Juniors
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <p class="mb-0 text-secondary">Showing <strong>1326</strong>
                                                                of <strong>1300+ </strong>marketers.<a href="#" class="text-secondary"> <strong>Reset
                                                                    filters</strong></a>
                                                            </p>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col">
                                                            <div class="card-body">
                                                                <div
                                                                    ...
                                                                    <h3 class="card-title"
                                                                        style="font-weight: bold; font-size: 20px;">Full
                                                                        Stack Marketer with 6 years of
                                                                        experience.</h3>
                                                                ...
                                                                <p class="text-secondary">I have been doing marketing for over 14 years now. I have had
                                                                    a part time client
                                                        ...
                                                        <div class="col">
                                                            <div class="card-body">
                                                                <div
                                                                    ...
                                                                    <h3 class="card-title"
                                                                        style="font-weight: bold; font-size: 20px;">Full
                                                                        Stack Rails Developer with 6 years of
                                                                        experience.</h3>
                                                                    <p><svg xmlns="http://www.w3.org/2000/svg"
                                                                            width="24" height="24" viewBox="0 0 24 24"
                                                                            fill="none" stroke="#22C55E"
