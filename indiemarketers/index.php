                ...
                <div class="container-xl">
                    <div class="row row-deck row-cards">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-10">
                                            <h1 class="h1 text-center responsive-title"
                                                ...
                                                ultimate job board for Indie Marketers</h1>
                                            <h3 class="h1 text-center d-none d-md-block">IndieMarketers puts
                                                freelance marketers and copywriters<span style="color: grey;"> in the spotlight for
                                                    their next opportunity.
                                                    Forget hunting through endless listings—let companies come to you
                                                    directly.</span></h3>
                                            <div class="mt-3 text-center">
                                                <a href="rovergigs/indiemarketers/roles/new.php" class="btn btn-lg"
                                ...
                                <div class="row g-2 align-items-center">
                                    <div class="col">
                                        <h2 class="page-title" style="margin-left: -15px;">
                                            New Marketers on IndieMarketers
                                        </h2>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12" style='cursor: pointer;'
                            onclick="window.location='/rovergigs/railsdevs/Developers/hire.php?id=<?php echo $developer['id']; ?>';">
                            <div class="card">
                                <!-- Card with image -->
                        ...
                        <div>
                            <div class="card-footer text-end">
                                <a href="Developers/more-devs.php" class="btn"
                                    style="background-color: #fe7470; color: white; font-size: 16px;">See more marketers
