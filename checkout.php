...
<head>
    ...
    <title>RoverGigs - Checkout</title>
    <!-- CSS files -->
            ...
            <div class="container-xl">
                ...
                <div class="navbar-nav flex-row order-md-last">
                    <div class="nav-item me-3">
                        <div class="btn-list">
                            <!--To be launched in 6months-->
                            <!--
              <a href="/weareremoteokay/join-early-access.php" class="btn btn-outline-primary" target="_blank" rel="noreferrer">
                Join early access to Jobs $99
              </a>-->
                            <!-- <a href="/rovergigs/post-a-job.php" class="btn btn-danger" target="_blank"
                                rel="noreferrer">
                                Post a job
                            </a> -->
                        </div>
            ...
            <div class="page-body">
                <div class="container-xl">
                    <div class="row row-cards">
                        <div class="col-sm-6 col-lg-4">
                            <div class="card card-md">
                                <div class="card-body text-center">
                                    <div class="text-uppercase text-secondary font-weight-medium">Standard Job
                                        Posting(Free)</div>
                                    ...
                                    <ul class="list-unstyled lh-lg">
                                        ...
                                        <li>
                                            ...
                                            Show company logo beside my post
                                        </li>
                                        <li>
                                            <!-- Download SVG icon from http://tabler-icons.io/i/x -->
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon me-1 text-danger"
                                            ...
                                            Highlight your post in yellow
                                        </li>
                                    </ul>
                                    <div class="text-center mt-4">
                                        <a href="https://rovergigs.gumroad.com/l/ixtez" class="btn w-100">Choose
                                            plan</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="card card-md">
                                <div class="ribbon ribbon-top ribbon-bookmark" style="background-color: #fe7470;">
                                ...
                                <div class="card-body text-center">
                                    <div class="text-uppercase text-secondary font-weight-medium">Highlighted Job
                                        Posting</div>
                                    <div class="display-5 fw-bold my-3">$90</div>
                                    <ul class="list-unstyled lh-lg">
                                        <li>
                                            <!-- Download SVG icon from http://tabler-icons.io/i/check -->
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon me-1 text-success"
                                            ...
                                            Show company logo besides my post
                                        </li>
                                        <li>
                                            <!-- Download SVG icon from http://tabler-icons.io/i/check -->
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon me-1 text-success"
                                        ...
                                        <li>
                                            ...
                                            Get support and help with your job post
                                        </li>
                                        <li>
                                            <!-- Download SVG icon from http://tabler-icons.io/i/x -->
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon me-1 text-danger"
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="card card-md">
                                <div class="card-body text-center">
                                    <div class="text-uppercase text-secondary font-weight-medium">Premium Job Posting
                                    </div>
                                    ...
                                    <div class="text-center mt-4">
                                        <a href="https://rovergigs.gumroad.com/l/rrqke" class="btn w-100">Choose
                                            plan</a>
                                    </div>
                                </div>
                            </div>
