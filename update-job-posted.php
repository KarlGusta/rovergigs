...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $valueMemberOnly = $_POST["valueMemberOnly"];
    $post_date = date('Y-m-d H:i:s');

    // Check that we don't have any empty fields
    do {
        if (empty($jobTitle) || empty($category) || empty($isThisRoleOpenWorldwide) || empty($applicationLinkOrEmail) || empty($jobType) || empty($jobDescription) || empty($companyName) || empty($companyHQ) || empty($companyWebsiteURL) || empty($email) || empty($companyDescription) || empty($status) || empty($featured) || empty($valueMemberOnly)) {
        ...
        foreach ($isThisRoleOpenWorldwide as $isThisRoleOpenWorldwideItem) {
            foreach ($jobType as $jobTypeItem) {
                $sql = "INSERT INTO jobs(jobTitle, category, isThisRoleOpenWorldwide, applicationLinkOrEmail, jobType, jobDescription, companyName, companyHQ, companyWebsiteURL, email, companyDescription, datePosted, status, featured, valueMemberOnly, post_date)" .
                    "VALUES ('$jobTitle', '$category', '$isThisRoleOpenWorldwideItem', '$applicationLinkOrEmail', '$jobTypeItem', '$jobDescription', '$companyName', '$companyHQ', '$companyWebsiteURL', '$email', '$companyDescription', now(), '$status', '$featured', '$valueMemberOnly', $post_date)";
            }
        }
        ...
        $successMessage = "Congratulations on posting a new job!";

        // Redirect the user to the lipa early access index page.
        header("location: /rovergigs/index.php");
        exit;
    } while (false);
}
?>
...
<head>
    ...
    <title>Update a Job | Rover gigs</title>
    <!-- CSS files -->
...
<body>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post">
                                            ...
                                            <div class="form-group mb-3 row">
                                                ...
                                                <div class="col">
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="<?php echo $jobTitle ?>" required>
                                            ...
                                            <div class="form-group mb-3 row">
                                                ...
                                                <div class="col">
                                                    <select type="text" class="form-select" placeholder="Select tags"
                                                        id="select-tags-two" value="" multiple>
                                        ...
                                        <!-- Location of the job -->
                                        <div class="form-group mb-3 row">
                                                <label class="form-label col-3 col-form-label">Job is restricted to locations? *</label>
                                                <div class="col">
                                                    <select type="text" class="form-select" placeholder="Select a date"
                                                        id="select-tags" name="category"
                                                        value="<?php echo $category ?>">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    ...
                                                    <select type="text" class="form-select"
                                                            placeholder="Select a date" id="select-tags" name="category"
                                                            value="<?php echo $category ?>">
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <small class="form-hint"><strong>It's illegal to not share salary range on job posts since 2021.</strong> Posts without salary will automatically show an estimate of salary based on similar jobs. Remote job postings are <a href="https://www.natlawreview.com/article/colorado-pay-transparency-more-guidance-job-promotional-posting-requirements-issued">legally required to show a salary compensation range in many U.S. states and countries.</a> Google does NOT index jobs without salary data. If it's a short-term gig, use the annual full-time equivalent. For example, if it's a 2-week project for $2,000, the annual equivalent would be $2,000 / 2 weeks * 52 weeks = $52,000. Please use USD equivalent. We don't have currency built-in yet and we'd like to use this salary data to show salary trends in remote work. Rover Gigs is a supporter of #OpenSalaries.</small>
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <textarea class="form-control" id="mytextarea" name="jobDescription"
                                                    ...
                                                    value="<?php echo $jobDescription ?>">Oh! Come and see the violence inherent in the system! Help, help, I'm being repressed! We shall say 'Ni' again to you, if you do not appease us. I'm not a witch. I'm not a witch. Camelot!</textarea>
                                            </div>
                                        </div>
                                        <div class="col mb-3">
                                            <!-- Page pre-title -->
                                            ...
                                            <div class="form-group mb-3 row">
                                                ...
                                                <div class="col">
                                                    <textarea class="form-control" id="mytextarea"
                                                        name="companyDescription" rows="6" placeholder="Content.."
                                                        value="<?php echo $companyDescription ?>">Oh! Come and see the violence inherent in the system! Help, help, I'm being repressed! We shall say 'Ni' again to you, if you do not appease us. I'm not a witch. I'm not a witch. Camelot!</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group mb-3 row">
                                            ...
                                            <div class="form-group mb-3 row">
                                                <label class="form-label col-3 col-form-label">Value Member
                                                    Only*</label>
                                                <div class="col">
                                                    <select class="form-select" name="valueMemberOnly"
                                                        value="<?php echo $valueMemberOnly ?>">
                                                        <option value="Yes">Yes</option>
                                                        <option value="No">No</option>
                                                    </select>
                                                </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            var el;
            window.TomSelect && (new TomSelect(el = document.getElementById('select-tags-two'), {
