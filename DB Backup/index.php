            ...
            <div class="container-xl">
                ...
                <div class="navbar-nav flex-row order-md-last">
                    <div class="nav-item me-3">
                        <div class="btn-list">
                            <a href="/post-a-job.php" class="btn btn-danger d-none d-md-block" target="_blank"
                                rel="noreferrer">
                                Post a remote job
                            </a>
                        </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-10">
                                            ...
                                            <div class="mt-3 text-center">
                                                <a href="/post-a-job.php" class="btn btn-danger"
                        ...
                        <div class="col-12">
                            <div class='row row-cards'>
                                <div class='space-y'>
                                    ...
                                    $username = "sjhzinnx_root";
                                    $password = "38!JqCXpP*EM8A@p";
                                    $database = "sjhzinnx_rovergigs";
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        $redirectUrl = $row['valueMemberOnly'] === 'Yes' ? "/apply.php?id=$row[jobId]" : '/value-membership.php'; // Redirect based on membership type
                                        ...
                                        echo "
                            <div class='card' style='$rowColor cursor: pointer;' onclick=\"window.location='$redirectUrl';\">
                                <div class='row g-0'>
                                    <div class='col-auto'>
                                        <div class='card-body'>
                                            <div class='avatar-md'>
