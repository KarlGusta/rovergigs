...
$location = "";
$minimumSalary = "40000"; // Default value
$maximumSalary = "60000"; // Default value
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $applicationLinkOrEmail = str_replace("https://", "", $applicationLinkOrEmail); // Remove https://
    ...
    do {
        if (empty($jobTitle) || empty($category) || empty($jobTags) || empty($isThisRoleOpenWorldwide) || empty($location) || empty($minimumSalary) || empty($maximumSalary) || empty($applicationLinkOrEmail) || empty($jobType) || empty($jobDescription) || empty($companyName) || empty($companyHQ) || empty($companyWebsiteURL) || empty($email) || empty($companyDescription) || empty($status) || empty($featured) || empty($valueMemberOnly)) {
        ...
        foreach ($isThisRoleOpenWorldwide as $isThisRoleOpenWorldwideItem) {
            foreach ($jobType as $jobTypeItem) {
                $sql = "INSERT INTO jobs(jobTitle, category, isThisRoleOpenWorldwide, location, minimum_salary, maximum_salary, applicationLinkOrEmail, jobType, jobDescription, companyName, companyHQ, companyWebsiteURL, email, companyDescription, datePosted, status, featured, valueMemberOnly, post_date)" .
                    "VALUES ('$jobTitle', '$category', '$isThisRoleOpenWorldwideItem', '$location', '$minimumSalary', '$maximumSalary','$applicationLinkOrEmail', '$jobTypeItem', '$jobDescription', '$companyName', '$companyHQ', '$companyWebsiteURL', '$email', '$companyDescription', now(), '$status', '$featured', '$valueMemberOnly', '$post_date')";
            }
        }
        ...
        $jobId = $connection->insert_id;

        // Insert job tags
        if (!empty($jobTags)) {
            $tagStmt = $connection->prepare("INSERT INTO job_tags (job_id, tag_name) VALUES (?, ?)");
            foreach ($jobTags as $tag) {
                $tagStmt->bind_param("is", $jobId, $tag);
                if (!$tagStmt->execute()) {
                    $errorMessage = "Error inserting tag: " . $tagStmt->error;
        ...
        header("location: /rovergigs/checkout.php");
        exit;
    } while (false);
}
?>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post">
                                            ...
                                            <div class="form-group mb-3 row">
                                                ...
                                                <div class="col">
                                                    <select type="text" class="form-select" placeholder="Select tags"
                                                        id="job-tags" name="jobTags[]" value="" multiple>
                                        ...
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <select type="text" class="form-select" placeholder="Select a date"
                                                    id="select-tags" name="location" value="<?php echo $location ?>">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="col">
                                                        <select type="text" class="form-select"
                                                            ...
                                                            name="minimumSalary" value="<?php echo $minimumSalary ?>">
                                            ...
                                            <div class="col-lg-5">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="col">
                                                        <select type="text" class="form-select"
                                                            placeholder="Select a date" id="select-tags"
                                                            name="maximumSalary" value="<?php echo $maximumSalary ?>">
                                            ...
                                            <div class="form-group mb-3 row">
                                                ...
                                                <div class="col">
                                                    <textarea id="tinymce-mytextarea" name="companyDescription"
                                                        value="<?php echo $companyDescription ?>"
