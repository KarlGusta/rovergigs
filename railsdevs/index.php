                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-10">
                                            <h1 class="h1 text-center responsive-title"
                                                ...
                                                developers</h1>
                                            <h3 class="h1 text-center d-none d-md-block">RailsDevs puts
                                            ...
                                            <div class="mt-3 text-center">
                                                <a href="/rovergigs/railsdevs/roles/new.php" class="btn btn-lg"
                                    ...
                                    <div class="row row-0 mb-2">
                                        <div class="col-3 me-3 d-flex justify-content-center align-items-center">
                                            ...
                                            if (!empty($imageUrl) && @getimagesize("Developers/" . $imageUrl)): ?>
                                                <img src="Developers/<?php echo $imageUrl; ?>" class="card-img-start" alt="Developer image"
