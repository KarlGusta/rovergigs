...
<head>
    ...
    <!--Favicon-->
    <link rel="icon" type="image/x-icon" href="src/img/logo/logo.png">
</head>
            ...
            <div class="page-body">
                <div class="container-xl">
                    <div class="row row-deck row-cards">
                        ...
                        <!--Front Banner-->
                        <div class="col-12">
                            <div class="card card-md" style="height: 60vh;">
                        ...
                        <!-- 5 Developer cards -->
                        <div class="col-12" style='cursor: pointer;' onclick="window.location='/Developers/hire.php';">
                            <div class="card">
                                <!-- Card with image -->
                                <div class="row row-0 mb-2">
                                    <div class="col-3 me-3">
                                        <!-- Photo -->
                                        <img src="Images/image1.png" class="w-100 h-100 object-cover card-img-start"
                                            alt="Beautiful blonde woman relaxing with a can of coke on a tree stump by the beach" />
                                    </div>
                                    <div class="col">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <h3 class="card-title" style="font-weight: bold; font-size: 20px;">Card
                                                    with left side image</h3>
                ...
                <div class="offcanvas-body">
                    <div class="container text-center">
                        ...
                        <div class="row align-items-center justify-content-center">
                            <!-- Centering the row -->
                            <div class="col" style="font-weight: bold; font-size: 16px;"><strong>Get new jobs sent to
                                    you</strong>📥</div>
                            <div class="col-auto">
